...
public class ComponentJLabel extends JLabel
{
    ...
    public ComponentJLabel(JComponent c)
    {
    ...
    public void setComponent(JComponent c)
    {
        ...
        if(c != null)
        {
            // Err.pr( "$$$ Setting COMPONENT <" + toString() + "> times " + times);
            setText(toString());
        }
        else
        {
            // setTextNull always does this
            // Err.pr( "$$$ Setting COMPONENT NULL");
            setText("");
        }
    }
