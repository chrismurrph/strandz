...
public class MinimumDomainQuery implements DomainQueryI
{
    public void preExecute()
    {
        Err.error("preExecute()" + " not implemented");
    }

    public void postExecute(Collection c)
    {
        Err.error("postExecute()" + " not implemented");
    }

    public Collection execute()
    {
        Err.error("execute()" + " not implemented");
        return null;
    }
    ...
    {
        Err.error("getSingleResult()" + " not implemented");
        return null;
    }
