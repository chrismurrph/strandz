...
abstract public class XMLConnectionInfo extends SimpleConnectionInfo
{
    public XMLConnectionInfo( ConnectionEnum connectionEnum)
    {
    ...
    {
        Err.error("Just a placeholder class, study XMLWombatData to code properly");
