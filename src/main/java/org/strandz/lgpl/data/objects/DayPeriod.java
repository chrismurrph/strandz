...
{
    public DayPeriod( Calendar calendar)
    {
        super( calendar);
    }

    public DayPeriod( Date date)
    {
        super( date);
    }
    ...
    void chk()
    {
        //Err.pr( "chk() doing nothing in " + this.getClass().getName());
    }

    Period createClone()
    {
        return new DayPeriod( calendar);
    }

    public Period next()
    {
        Period result = createClone();
        result.calendar.add( Calendar.DATE, 1);
        return result;
    }
    ...
    public Date getEndPoint()
    {
        ...
        result = TimeUtils.addDays( result, 1);
        return result;
    }
