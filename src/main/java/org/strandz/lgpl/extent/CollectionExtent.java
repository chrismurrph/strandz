...
class CollectionExtent extends IndependentExtent
{
    private MyCollection actualList;

    CollectionExtent(EntityManagerProviderI entityManagerProvider, InsteadOfAddRemoveTrigger addRemoveTrigger)
    {
        super(entityManagerProvider, addRemoveTrigger);
    }

    CollectionExtent(Object actualList, EntityManagerProviderI entityManagerProvider, InsteadOfAddRemoveTrigger addRemoveTrigger)
    {
        super(entityManagerProvider, addRemoveTrigger);
        ...
        this.actualList = new MyCollection((Collection) actualList);
    }

    /*
    * Testing - will later have to implement previous/next etc, and keep up
    * to date with rowNum to implement Collection as a subclass.
    */
    int getType()
    {
    ...
    public void setList(Object masterElement, Tie tie)
    {
        ...
        // should check that field is a Collection
        Collection set = (Collection) tie.getFieldValue(masterElement);
        /*
        ...
        */
        ...
        {
            actualList = new MyCollection(set);
        }
    }
    ...
    private MyCollection getInternalActualList()
    {
        if(actualList == null)
        {
    ...
    /**
     * Collections have no idea of order, yet we need to display a
     ...
     */
    class MyCollection // implements List (can't do 'cause it's an inner class)
    {
