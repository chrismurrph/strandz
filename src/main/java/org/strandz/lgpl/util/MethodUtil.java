...
import org.strandz.lgpl.util.ReflectUtil;
...
public final class MethodUtil extends SecureClassLoader
{
     ...
     */
     public static Method[] getPublicMethods(Class cls) {
        ...
        Map<MethodUtil.Signature, Method> sigs = new HashMap<MethodUtil.Signature, Method>();
        while (cls != null) {
    ...
    private static void getInterfaceMethods(Class cls,
                                            Map<MethodUtil.Signature, Method> sigs) {
    ...
    private static void addMethod(Map<MethodUtil.Signature, Method> sigs, Method method) {
        MethodUtil.Signature signature = new MethodUtil.Signature(method);
    ...
    private static class Signature {
        ...
        public boolean equals(Object o2) {
            ...
            MethodUtil.Signature that = (MethodUtil.Signature)o2;
