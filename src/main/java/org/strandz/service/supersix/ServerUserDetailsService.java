...
public class ServerUserDetailsService extends AbstractUserDetailsService
{
    ...
    {
        setDataStore( ServiceFactoryUtils.getDataStore());
    }
     ...
     * made runnable via `jar -f superSixSpring.jar`, and are self documenting as to their
     * dependencies. 
     */
    public static void main(String[] args)
    {
        ...
        UserDetailsTransferObj received = service.getUserDetails( "Leo");
    ...
    {
        return SuperSixDomainQueryEnum.ALL_USER;
    }
}
