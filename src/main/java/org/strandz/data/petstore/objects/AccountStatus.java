...
public class AccountStatus
{
    ...
    public AccountStatus()
    {
        ...
        id = timesConstructed;
        /*
        Err.pr( "AccountStatus ### CREATED id: " + id);
        if(id == 0)
        {
        Err.stack();
        }
    ...
    public boolean equals(Object o)
    {
        ...
        else if(!(o instanceof AccountStatus))
        {// nufin
        }
        else
        {
            AccountStatus test = (AccountStatus) o;
    ...
    public static final AccountStatus NULL = new AccountStatus();
    ...
    public static final AccountStatus[] OPEN_VALUES = {NULL, OPEN, CLOSED};
