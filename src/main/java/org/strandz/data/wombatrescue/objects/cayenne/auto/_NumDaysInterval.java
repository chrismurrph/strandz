...
/**
 * Class _NumDaysInterval was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _NumDaysInterval extends CayenneDataObject {
    ...
    public void setActualDays(Integer actualDays) {
        writeProperty("actualDays", actualDays);
    }
    public Integer getActualDays() {
        return (Integer)readProperty("actualDays");
    }
