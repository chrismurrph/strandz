...
/**
 * A generated persistent class mapped as "NumDaysInterval" Cayenne entity. It is a good idea to
 * avoid changing this class manually, since it will be overwritten next time code is
 * regenerated. If you need to make any customizations, put them in a subclass.
 */
public abstract class _NumDaysInterval extends PersistentObject {

    public static final String ACTUAL_DAYS_PROPERTY = "actualDays";
    ...
    public Integer getActualDays() {
        if(objectContext != null) {
            objectContext.prepareForAccess(this, "actualDays", false);
        }
    ...
    public void setActualDays(Integer actualDays) {
        ...
        Object oldValue = this.actualDays;
        this.actualDays = actualDays;

        // notify objectContext about simple property change
        if(objectContext != null) {
            objectContext.propertyChanged(this, "actualDays", oldValue, actualDays);
        }
    }
