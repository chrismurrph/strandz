...
public class ThickClientUploadRosterService extends AbstractClientUploadRosterService implements UploadRosterServiceI
{
    public String uploadRoster(String roster, int whichMonth, MonthInYearI monthInYear)
    {
        Err.error("uploadRoster()" + " not implemented");
        return null;
    }
}
