...
public class MockRosterService implements ServiceI
{
    public RosterTransferObj getRoster(int what, MonthTransferObj month)
    {
        RosterTransferObj result;
        StringBuffer roster = new StringBuffer( "Roster for " + month);
        result = new RosterTransferObj( month.month, month.year, roster, null);
        return result;
    }
