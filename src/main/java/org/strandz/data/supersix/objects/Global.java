...
{
    private SeasonYear currentSeasonYear;
    private Competition currentCompetition;

    public SeasonYear getCurrentSeasonYear()
    {
        return currentSeasonYear;
    }

    public void setCurrentSeasonYear(SeasonYear currentSeasonYear)
    {
    ...
    {
        String result;
        result = "Global: <currentSeasonYear: " + getCurrentSeasonYear() + 
