...
public class PopulateUpdateLOV
{
    ...
    private static final NumDaysInterval TO_CREATE_LIST[] = NumDaysInterval.OPEN_VALUES;
    ...
    public static void main(String s[])
    {
        ...
        {
            String str[] = {WombatConnectionEnum.SERVER_CAYENNE.getName()};
    ...
    private void processParams(String s[])
    {
        ...
        */
        ...
        dataStore.startTx();
        doPopulation(TO_CREATE_LIST, dataStore);
        if(!commitPopulation)
        {
    ...
    List doPopulation(Object toCreateList[], EntityManagedDataStore dataStore)
    {
