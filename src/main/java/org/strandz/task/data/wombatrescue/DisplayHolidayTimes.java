...
public class DisplayHolidayTimes
{
    ...
    private static void displayHolidayTime(Date date, String text)
    {
        int hours = TimeUtils.getHours(date);
        int minutes = TimeUtils.getMinutes(date);
