...
public class DisplayXMLFile
{
    public static void main(String s[])
    {
        ...
        {
            String str[] = {"POJOWombatData", WombatConnectionEnum.BACKUP.getName()};
            processParams(str);
    ...
    private static void processParams(String s[])
    {
        if(s[0].equals("POJOWombatData"))
        {
            ...
            //DataStore from = WombatDataFactory.getNewInstance( WombatConnectionEnum.getFromName( s[1]), WombatDataFactory.XML).getData();
