 ...
 * 
 */
public class NewReferenceColumn
{
    ...
    private static void update(DataStore data)
    {
        ...
        {
            RosterSlotI rosterSlot = (RosterSlotI) iter.next();
            if(rosterSlot.getNotInMonth() == null)
            {
                rosterSlot.setNotInMonth(MonthInYear.NULL);
            }
            if(rosterSlot.getOnlyInMonth() == null)
            {
                rosterSlot.setOnlyInMonth(MonthInYear.NULL);
            }
            rosterSlot.clearUnavailableDates();
        }
    }
}
