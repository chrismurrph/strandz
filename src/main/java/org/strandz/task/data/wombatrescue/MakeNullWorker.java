...
public class MakeNullWorker
{
    ...
    public static void main(String s[])
    {
        ...
        {
            //Directly use on production machine:
            String str[] = {"DevData", WombatConnectionEnum.WOMBAT_KODO.getName()};
            //Use against local Tomcat (see MakeNullWorkerOnSecure for this)
            //String str[] = {"DevData", WombatConnectionEnum.REMOTE_DEMO_WOMBAT_KODO.getName()};            
            processParams(str);
        }
        System.exit(0);
    }
