...
public class AdjustRosterSlotForWorker
{
    ...
    private static void update(DataStore data)
    {
        ...
        for(Iterator iter = list.iterator(); iter.hasNext();)
        {
            ...
            Err.error("rosterSlot.getVolunteer() no longer exists");
            /*
            Volunteer vol = rosterSlot.getVolunteer();
            ...
            rosterSlot.setWorker( worker);
            //Worker currentWorker = rosterSlot.getWorker();
