...
public class DisplayGroups
{
    ...
    private static void display(DataStore data)
    {
        ...
        for(Iterator iter = list.iterator(); iter.hasNext();)
        {
            ...
            //boolean b4 = JDONote.APPEARS_CONSTRUCTOR_NOT_CALLED.isVisible();
            //JDONote.APPEARS_CONSTRUCTOR_NOT_CALLED.setVisible(false);
            // Err.pr( "VOL: " + vol + ", BELONGS: " + vol.getBelongsToGroup());
            //JDONote.APPEARS_CONSTRUCTOR_NOT_CALLED.setVisible(b4);
        }
    }
}
