...
import org.strandz.data.supersix.business.SuperSixManager;
...
public class CalculateDraws
{
    public static void main( String args[])
    {
        SuperSixManager superSixManager = new SuperSixManager();
        ...
        superSixManager.init( ds);
        SuperSixLookups superSixLookups = (SuperSixLookups)ds.getLookups();
        try
        {
            CompetitionSeason competitionSeason = superSixManager.getCurrentSeason( superSixManager.getGlobal());
            superSixManager.calculateDraws(competitionSeason, superSixLookups, DayInWeek.TUESDAY);
            superSixManager.calculateDraws(competitionSeason, superSixLookups, DayInWeek.TUESDAY);
        }
