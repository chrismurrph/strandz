...
public class TrialSdzImageIcon
{
    public static void main(String s[])
    {
        new TrialSdzImageIcon();
    }

    public TrialSdzImageIcon()
    {
        String portableTxt = "images/Calendar.gif";
        PortableImageIcon imageIcon = new PortableImageIcon();
        imageIcon.setLocation(portableTxt);
