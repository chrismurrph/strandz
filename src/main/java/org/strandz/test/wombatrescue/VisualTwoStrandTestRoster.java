 ...
 */
public class VisualTwoStrandTestRoster extends TwoStrandTestRoster
{
    public static void main(String s[]) throws Exception
    {
        VisualTwoStrandTestRoster obj = new VisualTwoStrandTestRoster();
        obj.setUp();
        obj.testTabSwitchingChangingRosterability();
        obj.tearDown();
    }
    
    public VisualTwoStrandTestRoster()
    {
    ...
    {
        return new TestSuite(VisualTwoStrandTestRoster.class);
    }
}
