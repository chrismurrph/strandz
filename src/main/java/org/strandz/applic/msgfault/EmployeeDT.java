...
public class EmployeeDT
{
    ...
    public Node employeeNode;
    public Cell employeeCell;

    public EmployeeDT(SdzBagI sdzBag)
    {
        ui0 = (JPanel) sdzBag.getPane(0);
        strand = sdzBag.getStrand();
        employeeNode = strand.getNodeByName("Employee Node");
        employeeCell = employeeNode.getCell();
    }
}
