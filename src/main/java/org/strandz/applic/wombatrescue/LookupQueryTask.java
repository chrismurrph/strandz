...
{
    RostererSessionI currentBO;
    LookupsI result;

    public LookupQueryTask(RostererSessionI currentBO, int duration)
    {
        setTitle("Fetching Lookup Data...");
    ...
    public class ActualTask
    {
        ActualTask()
        {
            result = (LookupsI)RosterSessionUtils.initLookups( currentBO);
        }
    }
