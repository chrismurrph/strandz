...
public class StartupMemoryDemo extends Startup
{
    public StartupMemoryDemo()
    {
        ...
        RosterSessionUtils.setMemoryProperty( "memory", "true");
        //S/be set like this in the properties file that use over JWS (and memory properties are mutually exclusive)
        //RosterSessionUtils.setMemoryProperty( "useSpring", "false");
        init();
    ...
    public static void main(String[] args)
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            public void run()
            {
                new StartupMemoryDemo().setVisible(true);
            }
        });
    }
}
