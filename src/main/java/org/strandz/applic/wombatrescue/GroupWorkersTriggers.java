...
public class GroupWorkersTriggers extends RosterWorkersTriggers
{
    GroupWorkersTriggers(SdzBag sdzBag, RosterWorkers_NEW_FORMATDT dt, EntityManagedDataStore dataStore, 
                         DomainQueriesI queriesI, RosterWorkersOps workerOps, 
                         LookupsI wombatLookups, VisibleStrandI visibleStrand)
    {
