...
public class ReportAddressesStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportAddressesStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List addresses = reports.reportAddresses();
            textAreaDisplayPanel.getTextArea().setText("");
            textAreaDisplayPanel.getTextArea().append(addresses.toString());
