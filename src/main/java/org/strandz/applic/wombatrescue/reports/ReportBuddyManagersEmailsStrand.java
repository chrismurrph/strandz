...
public class ReportBuddyManagersEmailsStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportBuddyManagersEmailsStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List emails = reports.reportBuddyManagersEmails();
            textAreaDisplayPanel.getTextArea().setText("");
            textAreaDisplayPanel.getTextArea().append(emails.toString());
