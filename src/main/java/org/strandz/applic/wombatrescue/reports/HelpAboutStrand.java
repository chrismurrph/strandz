...
public class HelpAboutStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    private Application application;
    private JComponent surface;

    public HelpAboutStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            surface.add(helper.getAcknowledgementsPanel(), BorderLayout.CENTER);
