...
public class ReportOvernightCapableStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportOvernightCapableStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List vols = reports.reportOvernightCapable( false);
