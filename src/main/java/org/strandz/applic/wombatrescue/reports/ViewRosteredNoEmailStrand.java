...
public class ViewRosteredNoEmailStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ViewRosteredNoEmailStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            else
            {
                ...
                StringBuffer buf = bo.display(RosteringConstants.ROSTERED_NO_EMAIL_VOLS);
                textAreaDisplayPanel.getTextArea().setText("");
                textAreaDisplayPanel.getTextArea().append(buf.toString());
                surface.removeAll();
