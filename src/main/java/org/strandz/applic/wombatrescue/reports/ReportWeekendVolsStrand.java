...
public class ReportWeekendVolsStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportWeekendVolsStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List contacts = reports.reportWeekendOvernighters();
