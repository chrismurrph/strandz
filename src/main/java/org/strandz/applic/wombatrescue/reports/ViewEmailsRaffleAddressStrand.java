...
public class ViewEmailsRaffleAddressStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ViewEmailsRaffleAddressStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            String msgTitle = RosterSessionUtils.getProperty( "organisationAcroymn") + " information request for raffle";
