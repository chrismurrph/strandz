...
public class ReportRosterableStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportRosterableStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List allInfo = reports.reportAllRosterable();
