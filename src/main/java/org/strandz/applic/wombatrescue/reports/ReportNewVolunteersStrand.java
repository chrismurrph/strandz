...
public class ReportNewVolunteersStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportNewVolunteersStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List newVols = reports.reportNewVolunteers();
            textAreaDisplayPanel.getTextArea().setText("");
            textAreaDisplayPanel.getTextArea().append(newVols.toString());
