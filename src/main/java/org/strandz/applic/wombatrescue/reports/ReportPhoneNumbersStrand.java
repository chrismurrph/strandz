...
public class ReportPhoneNumbersStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportPhoneNumbersStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List phoneNumbers = reports.reportPhoneNumbers(true);
            textAreaDisplayPanel.getTextArea().setText("");
            textAreaDisplayPanel.getTextArea().append(phoneNumbers.toString());
