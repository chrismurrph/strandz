...
public class ReportUnknownFlexibilityStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportUnknownFlexibilityStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List vols = reports.reportUnknownFlexibility( false);
