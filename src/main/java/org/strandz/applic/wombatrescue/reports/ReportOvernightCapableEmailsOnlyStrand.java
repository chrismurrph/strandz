...
public class ReportOvernightCapableEmailsOnlyStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportOvernightCapableEmailsOnlyStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List vols = reports.reportOvernightCapable( true);
