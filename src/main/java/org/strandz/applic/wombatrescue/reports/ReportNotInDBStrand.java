...
public class ReportNotInDBStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportNotInDBStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            new MessageDlg( "Have not yet implemented reportNotInDB()");
            /*
            List contacts = reports.reportNotInDB();
            textAreaDisplayPanel.getTextArea().setText("");
            textAreaDisplayPanel.getTextArea().append(contacts.toString());
