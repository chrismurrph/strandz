...
public class ViewUnrosteredVolsEmailsOnlyStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ViewUnrosteredVolsEmailsOnlyStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            else
            {
                ...
                List vols = reports.reportUnrosteredWorkers( true);
