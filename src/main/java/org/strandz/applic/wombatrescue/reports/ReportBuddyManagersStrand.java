...
public class ReportBuddyManagersStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportBuddyManagersStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List contacts = reports.reportBuddyManagers();
