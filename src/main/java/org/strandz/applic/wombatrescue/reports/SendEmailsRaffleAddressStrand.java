...
public class SendEmailsRaffleAddressStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    private Application application;
    private ParticularRosterI bo;

    public SendEmailsRaffleAddressStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            MessagesContainer con = bo.writeAllAddressAndRaffleMsgs();
            Informer emailer = new Emailer();
            emailer.setMsgs(RosterSessionUtils.getProperty( "organisationAcroymn") + " information request for raffle", con.emails);
            emailer.sendMsgs();
