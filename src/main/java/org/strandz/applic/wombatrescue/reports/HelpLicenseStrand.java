...
public class HelpLicenseStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    private Application application;
    private JComponent surface;

    public HelpLicenseStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            HelpLicenseHelper helper = new HelpLicenseHelper();
            surface.add(helper.getPanel(), BorderLayout.CENTER);
