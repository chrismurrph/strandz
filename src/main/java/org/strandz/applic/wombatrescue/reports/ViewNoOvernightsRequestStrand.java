...
public class ViewNoOvernightsRequestStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    private Application application;
    private JComponent surface;
    private TextAreaDisplayPanel textAreaDisplayPanel;

    public ViewNoOvernightsRequestStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            MessagesContainer con = bo.writeNoOvernightsRequestMsgs();
            String msgTitle = RosterSessionUtils.getProperty( "organisationAcroymn") + " specific rostering request";
