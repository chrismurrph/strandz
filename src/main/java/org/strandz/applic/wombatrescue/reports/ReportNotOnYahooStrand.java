...
public class ReportNotOnYahooStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportNotOnYahooStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List contacts = reports.reportNotOnYahoo();
