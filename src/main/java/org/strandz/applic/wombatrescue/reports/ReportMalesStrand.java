...
public class ReportMalesStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportMalesStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List males = reports.reportMaleEmails();
            textAreaDisplayPanel.getTextArea().setText("");
            textAreaDisplayPanel.getTextArea().append( Utils.getStringBufferFromList( males, new char[]{',','\n'}).toString());
