...
public class HelpAboutHelper
{
    ...
    private AcknowledgementsPanel.Bundle[] createAcknowledgementBundles()
    {
        ...
        result[0].name = "Wombat Rescue";
        result[0].link = "www.strandz.org";
        result[0].iconFile = "images/Splash.jpg";
        result[0].text = "Rostering Workers, saving wombats" +
            "<br>Copyright (C) 2007<br>Chris Murphy<br>" +
            "Wombat Rescue comes with ABSOLUTELY NO WARRANTY.<br>" +
        ...
        result[1].text = "The 'least code' framework" +
            "<br>Copyright (C) 2007<br>Chris Murphy";
