...
public class ReportGroupVolunteersStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportGroupVolunteersStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List vols = reports.reportGroupVolunteers();
