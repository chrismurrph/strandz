...
public class ReportNotOnYahooEmailsOnlyStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportNotOnYahooEmailsOnlyStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List contacts = reports.reportNotOnYahooEmailOnly();
            textAreaDisplayPanel.getTextArea().setText("");
            textAreaDisplayPanel.getTextArea().append(
                Reports.EmailInfo.simpleFormat(contacts));
