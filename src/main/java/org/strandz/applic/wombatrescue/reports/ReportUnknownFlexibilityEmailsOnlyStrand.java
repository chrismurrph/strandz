...
public class ReportUnknownFlexibilityEmailsOnlyStrand extends VisibleStrandAdapter implements VisibleStrandI
{
    ...
    public ReportUnknownFlexibilityEmailsOnlyStrand(Application a)
    {
        this.application = a;
    }
    ...
    public void display(boolean b)
    {
        if(b)
        {
            ...
            List vols = reports.reportUnknownFlexibility( true);
