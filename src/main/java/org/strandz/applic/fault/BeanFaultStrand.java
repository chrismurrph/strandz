...
public class BeanFaultStrand extends VisibleStrand
{
    private static final String FILENAME = "C:\\cml\\dt\\fault\\BeanFault.xml";
    public FaultQueries queries;
    //public SdzBagI sbI;
    public BeanFaultTriggers triggers;
    private BeanFaultDT dt;

    public BeanFaultStrand()
    {
        init();
    }

    public BeanFaultStrand(Application a)
    {
        super(a);
        init();
    }
    ...
    public void sdzSetup()
    {
        ...
        dt = new BeanFaultDT(sbI);
        triggers = new BeanFaultTriggers(getDataStore(), queries, dt, sbI);
