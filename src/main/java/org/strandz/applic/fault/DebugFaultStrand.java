...
public class DebugFaultStrand extends VisibleStrand
{
    private static String filename = "C:\\cml\\dt\\fault\\DebugFault.xml";
    public FaultQueries queries;
    //public SdzBagI sbI;
    public DebugFaultTriggers triggers;
    private DebugFaultDT dt;

    public DebugFaultStrand()
    {
        init();
    }

    public DebugFaultStrand(Application a)
    {
        super(a);
        init();
    }
    ...
    private void init()
    {
        setDataStore(FaultApplicationData.getSetInstance().getData());
        queries = FaultApplicationData.getSetInstance().getQueries();
    }
    ...
    {
        DebugFaultStrand obj;

        RunLater(DebugFaultStrand obj)
        {
            this.obj = obj;
        }
    ...
    public void sdzSetup()
    {
        ...
        dt = new DebugFaultDT(sbI);
        triggers = new DebugFaultTriggers(getDataStore(), queries, dt, sbI);
