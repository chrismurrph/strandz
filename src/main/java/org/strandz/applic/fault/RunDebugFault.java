...
public class RunDebugFault
{
    private static DebugFaultStrand RUN = new DebugFaultStrand();
    ...
    public static void main(String[] args)
    {
        ...
        RUN.setApplication(simple);
        VisibleStrandAction vsa = new VisibleStrandAction("DebugFault", "DebugFault");
