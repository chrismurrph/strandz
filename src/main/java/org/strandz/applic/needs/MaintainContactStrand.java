...
public class MaintainContactStrand extends VisibleStrand
{
    private static String filename = "C:\\cml\\dt\\needs\\MaintainContact.xml";
    public NeedsQueries queries;
    //public SdzBagI sbI;
    public MaintainContactTriggers triggers;
    private MaintainContactDT dt;

    public MaintainContactStrand()
    {
        init();
    }

    public MaintainContactStrand(Application a)
    {
        super(a);
        init();
    }
    ...
    private void init()
    {
        setDataStore(NeedsApplicationData.getInstance().getData());
        queries = NeedsApplicationData.getInstance().getQueries();
    }
    ...
    {
        MaintainContactStrand obj;

        RunLater(MaintainContactStrand obj)
        {
            this.obj = obj;
        }
