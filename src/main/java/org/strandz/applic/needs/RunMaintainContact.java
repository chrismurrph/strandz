...
public class RunMaintainContact
{
    private static MaintainContactStrand RUN = new MaintainContactStrand();
    ...
    public static void main(String[] args)
    {
        ...
        VisibleStrandAction vsa = new VisibleStrandAction("MaintainContact",
            "MaintainContact");
