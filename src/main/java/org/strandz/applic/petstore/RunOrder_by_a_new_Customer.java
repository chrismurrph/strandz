...
public class RunOrder_by_a_new_Customer
{
    private static Order_by_a_new_CustomerStrand RUN = new Order_by_a_new_CustomerStrand();
    ...
    public static void main(String[] args)
    {
        ...
        VisibleStrandAction vsa = new VisibleStrandAction("Order_by_a_new_Customer",
            "Order_by_a_new_Customer");
