...
class JDONeedsDataStore extends JDODataStore implements NeedsQueries
{
    public JDONeedsDataStore(String dbName)
    {
        super.setClasses(NeedsData.CLASSES);
    ...
    {
        Query q = ((PersistenceManager) getEM().getActualEM()).newQuery(NeedsData.CONTACT);
