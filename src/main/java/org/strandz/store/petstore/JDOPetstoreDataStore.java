...
class JDOPetstoreDataStore extends JDODataStore implements PetstoreQueries
{
    public JDOPetstoreDataStore(String dbName)
    {
        super.setClasses(PetstoreData.CLASSES);
    ...
    {
        Query q = ((PersistenceManager) getEM().getActualEM()).newQuery(PetstoreData.ACCOUNT);
