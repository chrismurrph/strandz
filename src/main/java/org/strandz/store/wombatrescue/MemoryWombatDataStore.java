...
public class MemoryWombatDataStore extends EntityManagedDataStore
{
    public MemoryWombatDataStore(MemoryConnectionInfo connection)
    {
        ...
        setDomainQueries( new MemoryWombatDomainQueries());
        Err.pr(SdzNote.EMP_ERRORS, "MemoryWombatDataStore constructor: " + connection);
    }
    ...
    public void startTx( String reason)
    {
        ...
        if(getEM() == null)
        {
            ...
            TaskI task = new MemoryWombatConnectionTask(this);
