...
public class FaultApplicationData
{
    ...
    */
    private FaultApplicationData(String type, String name)
    {
        ...
        queries = (FaultQueries) data;
    }

    public static FaultApplicationData getNewInstance()
    {
        return getNewInstance(databaseName);
    }

    public static FaultApplicationData getSetInstance()
    {
        FaultApplicationData result = instance1;
        if(result == null)
        {
    ...
    public static FaultApplicationData getNewInstance(String name, String storageType)
    {
        if(instance1 == null)
        {
            instance1 = new FaultApplicationData(storageType, name);
            if(storageType == JDO)
            {
    ...
    public static FaultApplicationData getNewInstance(String name)
    {
        if(instance1 == null)
        {
            instance1 = new FaultApplicationData(storageType, name);
    ...
    public static FaultApplicationData getInstance2(String name)
    {
        if(instance2 == null)
        {
            instance2 = new FaultApplicationData(storageType, name);
            if(storageType == JDO)
            {
    ...
    public static JDOFaultDataStore getJDOInstance2(String name)
    {
        ...
        {
            instance2 = new FaultApplicationData(JDO, name);
            jdoInstance2 = (JDOFaultDataStore) instance2.data;
        }
        return jdoInstance2;
    }
    ...
    public static XMLFaultData getXMLInstance2(String fileName)
    {
        ...
        {
            instance2 = new FaultApplicationData(XML, fileName);
            xmlInstance2 = (XMLFaultData) instance2.data;
        }
        return xmlInstance2;
    }
    ...
    {
        return queries.queryAllFaults();
    }

    public FaultQueries getQueries()
    {
        return queries;
    }
