...
class JDOFaultDataStore extends JDODataStore implements MsgfaultQueries
{
    ...
    {
        Query q = ((PersistenceManager) getEM().getActualEM()).newQuery(FaultData.PRODUCT);
    ...
    {
        Query q = ((PersistenceManager) getEM().getActualEM()).newQuery(FaultData.EMPLOYEE);
        Collection result = null;
        result = (Collection) q.execute();
        return result;
    }
