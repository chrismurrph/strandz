...
public class MemorySuperSixDataStore extends EntityManagedDataStore
{
    public MemorySuperSixDataStore(MemoryConnectionInfo connection)
    {
        super.setClasses(SuperSixData.CLASSES);
        ...
        setDomainQueries( new MemorySuperSixDomainQueries());
        Err.pr(SdzNote.EMP_ERRORS, "MemorySuperSixDataStore constructor: " + connection);
    }
    ...
    public void startTx( String reason)
    {
        ...
        if(getEM() == null)
        {
            ...
            TaskI task = new MemorySuperSixConnectionTask(this);
