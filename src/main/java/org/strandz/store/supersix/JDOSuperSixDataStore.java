...
public class JDOSuperSixDataStore extends JDODataStore
{
    /**
     ...
     */
    public JDOSuperSixDataStore(ConnectionInfo connectionInfo)
    {
        ...
        setDomainQueries( new JDOSuperSixDomainQueries());
        setName(connectionInfo.getName());
        setErrorThrower( Session.getErrorThrower());
        setSupportPhone( SuperSixManagerUtils.getProperty( "supportPhone"));
    }    
