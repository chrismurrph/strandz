...
/**
 * This class specifies how a ReferenceLinkAttribute will look to the programmer at
 * DT, and as such is used by SdzDsgnr.
 *
 * @author Chris Murphy
 */
public class ReferenceLinkAttributeBeanInfo extends SimpleBeanInfo
{
    ...
    private final static Class beanClass = ReferenceLinkAttribute.class;
    // will have to live with:
    private final static Class customizerClass = ReferenceLinkAttributeCustomizer.class;
}
