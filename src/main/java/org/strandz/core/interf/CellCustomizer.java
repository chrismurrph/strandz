...
import org.strandz.view.util.CellCustomizerPanel;

import java.util.ArrayList;
import java.util.List;

/**
 * This class is used for editing a Cell at DT.
 *
 * @author Chris Murphy
 */
public class CellCustomizer extends OneRowSdzBag
        implements CustomizerI
{
    ...
    public CellCustomizer()
    {
        ...
        CellCustomizerPanel panel = new CellCustomizerPanel();
        panel.init();
        cell = new Cell();
        cell.setClazz(new Clazz(org.strandz.core.interf.Cell.class));

        FieldAttribute fa = new FieldAttribute("name", panel.tfName);
        cell.addAttribute(fa);
        fa = new FieldAttribute("clazz", panel.tfClass);
        cell.addAttribute(fa);
        fa = new FieldAttribute("refField", panel.tfRefField);
        cell.addAttribute(fa);
        cell.setName("cell");
        node = new Node();
