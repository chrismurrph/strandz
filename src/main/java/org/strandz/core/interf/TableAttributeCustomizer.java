...
import org.strandz.view.util.TableAttributeCustomizerPanel;

import java.util.ArrayList;
import java.util.List;

/**
 * This class is used for editing a TableAttribute at DT.
 *
 * @author Chris Murphy
 */
public class TableAttributeCustomizer extends OneRowSdzBag
        implements CustomizerI
{
    private Node node;
    private Cell cell;
    private ArrayList beans = null;
    private TableAttributeCustomizerPanel panel;
    private TableAttribute object;

    public TableAttributeCustomizer()
    {
        setName( NameUtils.tailOfPackage( this.getClass().getName()));
        MessageDlg.setDlgParent( this);
        panel = new TableAttributeCustomizerPanel();
        panel.init();
        cell = new Cell();
        cell.setClazz(new Clazz(org.strandz.core.interf.TableAttribute.class));

        FieldAttribute fa = new FieldAttribute("dOField", panel.lfDOField);
        cell.addAttribute(fa);
        fa = new FieldAttribute("name", panel.tfName);
        cell.addAttribute(fa);
        fa = new FieldAttribute("columnHeading", panel.tfColumnHeading);
        cell.addAttribute(fa);
        fa = new FieldAttribute("ordinal", panel.tfOrdinal);
        cell.addAttribute(fa);
        ...
        setName("TableAttributeCustomizer");
    }

    public void setObject(Object obj)
    {
        beans = new ArrayList();
        object = (TableAttribute) obj;
        beans.add(object);
    }
