 ...
 * @author Chris Murphy
 */
class LoadDoneState extends LoadInsertDoneState
{
    static StrandState getNewInstance(StrandI context)
    {
        return new LoadDoneState(context);
    }

    LoadDoneState(StrandI context)
    {// Err.pr( "Now in LoadDone Sector constructor");
    }

    int getMode(StrandI context)
    {
        return Strand.LOADDONE;
    }
}
