...
/**
 * This allows a node to function inside a control that normally only
 * works with Strings.
 *
 * @author Chris Murphy
 */
public class NodeConvert extends AbstractObjectControlConvert
{
    public NodeConvert()
    {
        typeRequiredByControlAccessors = String.class;
        typeOfObject = Node.class;
    }

    public Object pushOntoScreen(Object object)
    {
        String result = null;
        Node bean = (Node) object;
        result = bean.getName();
        return result;
    }
