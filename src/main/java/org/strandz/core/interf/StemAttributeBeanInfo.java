...
/**
 * This class specifies how a StemAttribute will look to the programmer at
 * DT, and as such is used by SdzDsgnr.
 *
 * @author Chris Murphy
 */
public class StemAttributeBeanInfo extends SimpleBeanInfo
{
    ...
    private final static Class beanClass = StemAttribute.class;
    // will have to live with:
    private final static Class customizerClass = StemAttributeCustomizer.class;
}
