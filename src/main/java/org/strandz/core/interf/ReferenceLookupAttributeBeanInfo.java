...
/**
 * This class specifies how a ReferenceLookupAttribute will look to the programmer at
 * DT, and as such is used by SdzDsgnr.
 *
 * @author Chris Murphy
 */
public class ReferenceLookupAttributeBeanInfo extends SimpleBeanInfo
{
    ...
    private final static Class beanClass = ReferenceLookupAttribute.class;
    // will have to live with:
    private final static Class customizerClass = ReferenceLookupAttributeCustomizer.class;
}
