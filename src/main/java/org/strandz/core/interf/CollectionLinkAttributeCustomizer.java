...
import org.strandz.view.util.CollectionLinkAttributeCustomizerPanel;

import java.util.ArrayList;
import java.util.List;

/**
 * This class is used for editing a CollectionLinkAttribute at DT.
 *
 * @author Chris Murphy
 */
public class CollectionLinkAttributeCustomizer extends OneRowSdzBag
        implements CustomizerI
{
    private Node node;
    private Cell cell;
    private ArrayList beans = null;
    private CollectionLinkAttributeCustomizerPanel panel;
    private CollectionLinkAttribute object;

    public CollectionLinkAttributeCustomizer()
    {
        setName( NameUtils.tailOfPackage( this.getClass().getName()));
        MessageDlg.setDlgParent( this);
        panel = new CollectionLinkAttributeCustomizerPanel();
        panel.init();
        cell = new Cell();
        cell.setClazz(new Clazz(org.strandz.core.interf.CollectionLinkAttribute.class));
        ...
        setName("CollectionLinkAttributeCustomizer");
    }

    public void setObject(Object obj)
    {
        beans = new ArrayList();
        object = (CollectionLinkAttribute) obj;
        beans.add(object);
    }
    ...
    class LocalDataFlowListener implements DataFlowTrigger
    {
        public void dataFlowPerformed(DataFlowEvent evt)
        {
            ...
            if(evt.getID() == DataFlowEvent.PRE_QUERY)
            {
                ...
                // Could have had Attribute rather than this
                // panel.tfDetailNode.setText( object.getIndependent().);
            }
        }
    }
