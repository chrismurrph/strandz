...
public class ComponentInTextComponentConvert extends AbstractObjectControlConvert
{
    public ComponentInTextComponentConvert()
    {
        typeRequiredByControlAccessors = String.class;
        typeOfObject = JComponent.class;
    }

    public Object pushOntoScreen(Object object)
    {
        String result = null;
        JComponent bean = (JComponent) object;
