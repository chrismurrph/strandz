...
public class JTextAreaColumnLister extends AbstractOwnTableMethods
{
    public List getList(Object tableControl, String identifier)
    {
        Err.error("JTextAreaColumnLister getList() not yet implemented");
        return null;
    }

    public void setList(Object tableControl, String identifier, Object value)
    {
        Err.error("JTextAreaColumnLister setList() not yet implemented");
    }

    public Object getValue(Object tableControl, String identifier)
    {
        Err.error("JTextAreaColumnLister getValue() not yet implemented");
        return null;
    }

    public void setValue(Object tableControl, String identifier, Object value)
    {
        Err.error("JTextAreaColumnLister setValue() not yet implemented");
    }

    public Object getControlAt(Object tableControl, int row, int col)
    {
        Err.error("JTextAreaColumnLister getRendererAtColumn() not yet implemented");
        return null;
    }
    ...
    {
        Err.error("JTextAreaColumnLister setRenderer() not yet implemented");
    }

    public void repositionTo(Object tableControl, int row, int col)
    {
        Err.error("JTextAreaColumnLister repositionTo() not yet implemented");
    }
}
