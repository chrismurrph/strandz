...
public class PrimitiveBooleanComp implements NonVisualComp
{
    private boolean b;
    private String name;
    ...
    public PrimitiveBooleanComp()
    {
        id = ++constructedTimes;
    }

    public PrimitiveBooleanComp( String name)
    {
        this();
        this.name = name;
    }
    ...
    {
        return getClass().getName() + ", " + getName() + ", " + "ID: " + id + ", b: " + b;
    }
