...
public interface ProdNodeI extends MoveNodeI
{
    boolean GOTO();

    void fireRecordValidateEvent();

    void firePostingEvent(Object source, OperationEnum op, StateEnum origState);

    void fireNodeValidateEvent();
