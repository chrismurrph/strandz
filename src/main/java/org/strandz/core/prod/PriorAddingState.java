...
class PriorAddingState extends AnyAddingState
{
    static public BlockState newInstance(OperationsProcessor context)
    {
        return new PriorAddingState(context);
    }

    private PriorAddingState(OperationsProcessor context)
    {
        super(context);
    ...
    {
        return StateEnum.NEW_PRIOR;
    }

    StateEnum getNoMoveState()
    {
        return StateEnum.NOMOVE_NEW_PRIOR;
    }
