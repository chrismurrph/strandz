...
class NoMoveEditState extends EditingState
{
    public static BlockState newInstance(OperationsProcessor context)
    {
        return new NoMoveEditState(context);
    }

    private NoMoveEditState(OperationsProcessor context)
    {
        super(context);
    }
