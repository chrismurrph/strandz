...
public class SdzBagBeanInfo extends SimpleBeanInfo
{
    public PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try
        {
            ...
            pd[2] = new PropertyDescriptor("physicalController", beanClass);
            pd[3] = new PropertyDescriptor("statusBar", beanClass);
            pd[4] = new IndexedPropertyDescriptor("nodes", beanClass, "getNodes",
                "setNodes", "getNode", "setNode");
            pd[5] = new PropertyDescriptor("currentPane", beanClass);
            /*
            * Want to use in customizer, but not save
            */
            pd[6] = new PropertyDescriptor("currentPaneStr", beanClass);
            pd[6].setValue("transient", Boolean.TRUE);
             /**/
        }
    ...
    private final static Class beanClass = SdzBag.class;
    private final static Class customizerClass = SdzBagCustomizer.class;
}
