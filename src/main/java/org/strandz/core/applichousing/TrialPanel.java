...
public class TrialPanel
{
    ...
    private static MenuTabApplication TEST_PANEL = new MenuTabApplication(null);
    ...
    public void init()
    {
        JPanel panel = TEST_PANEL.getEnclosingPanel();
        ...
        */
        TEST_PANEL.show();
        TEST_PANEL.getEnclosingPanel().revalidate();
    }
}
