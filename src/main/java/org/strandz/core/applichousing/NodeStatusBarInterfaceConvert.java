 ...
 * @author Chris Murphy
 */
public class NodeStatusBarInterfaceConvert extends AbstractObjectControlConvert
{
    public NodeStatusBarInterfaceConvert()
    {
        typeRequiredByControlAccessors = String.class;
        typeOfObject = NodeStatusBarI.class;
    }

    public Object pushOntoScreen(Object object)
    {
        String result = null;
        NodeStatusBarI bean = (NodeStatusBarI) object;
