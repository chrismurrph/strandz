...
public interface SdzBeanI extends NameableI
{
    boolean validateBean();

    boolean validateBean(boolean childrenToo);

    List retrieveValidateBeanMsg();

    IconEnum getIconEnum();
    ...
    void setAlreadyBeenCustomized(boolean b);

    // Don't need these two by compiler, but making it
    // explicit to programmer:
    int hashCode();
