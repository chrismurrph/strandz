...
public class AddressGUISized extends AddressGUI
{
    public AddressGUISized()
    {
        /*
        ...
        */
        Dimension dim = new Dimension(super.getPreferredSize().width,
            super.getPreferredSize().height - 50);
        setPreferredSize(dim);
    }

    public void setVisible(boolean b)
    {
        // Err.pr( "AddressGUISized.setVisible " + b);
        super.setVisible(b);
    }
}
