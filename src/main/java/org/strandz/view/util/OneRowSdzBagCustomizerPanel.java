...
public class OneRowSdzBagCustomizerPanel extends JPanel
{
    ...
    private final Label lView = new org.strandz.lgpl.widgets.Label("View:  ");
    public ComponentLabelField tfView = null;
    private final JPanel jpViewRow = new JPanel();

    public OneRowSdzBagCustomizerPanel()
    {
    ...
    public void init()
    {
        ...
        add(jpNameRow);
        dim = new Dimension((int) lView.getPreferredSize().getWidth(),
            SHORT_ROW_HEIGHT);
