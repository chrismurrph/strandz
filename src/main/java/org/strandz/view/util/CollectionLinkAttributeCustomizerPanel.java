...
public class CollectionLinkAttributeCustomizerPanel extends JPanel
{
    ...
    /*
    private final Label lDetailNode = new Label( "Detail Node:  ");
    public LabelField tfDetailNode = null;
    private final JPanel jpDetailNodeRow = new JPanel();
    */

    public CollectionLinkAttributeCustomizerPanel()
    {
    ...
    public void init()
    {
        ...
        /*
        dim = new Dimension(
        (int)lDetailNode.getPreferredSize().getWidth(), SHORT_ROW_HEIGHT);
        tfDetailNode = new LabelField();
        tfDetailNode.setHeight( SHORT_ROW_HEIGHT);
        tfDetailNode.setName( "tfType");
        lDetailNode.setPreferredSize( dim);
        lDetailNode.setMaximumSize( dim);
        lDetailNode.setVerticalAlignment( SwingConstants.CENTER);
        jpDetailNodeRow.setLayout( new BoxLayout( jpDetailNodeRow, BoxLayout.X_AXIS));
        jpDetailNodeRow.setAlignmentX( SwingConstants.LEFT);
        jpDetailNodeRow.add( lType);
        jpDetailNodeRow.add( tfType);
        add( jpDetailNodeRow);
        */
    }
}
